...
public class LevelDouble : Level
{
    ...
    public virtual double NumberByLevel()
    {
        ...
        this.number = this.baseNumber * System.Math.Pow(baseMin, System.Math.Min(this.currentLevel, baseLimit)) * System.Math.Pow(baseMax, System.Math.Max(0, this.currentLevel - baseLimit));
